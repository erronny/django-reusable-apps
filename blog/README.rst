...
Posts is a Django app to conduct Web-based post. For each individual,
clients can choose this.
...
5. Visit http://127.0.0.1:8000/posts/ to participate in the poll.